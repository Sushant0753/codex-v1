...
export default function Hero() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-200">
      ...
      {/* Hero section */}
      <section className="relative flex flex-col items-center justify-center min-h-screen text-center pt-16">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <motion.p 
              className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-xl px-4 text-center"
            ...
            <motion.div 
              className="mt-8 flex flex-col sm:flex-row gap-4 px-4 justify-center"
